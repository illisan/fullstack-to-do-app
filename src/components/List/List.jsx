...
class List extends Component {
    ...
    //     let newTaskArr = [...this.props.tasks]; // using array spread syntax to make copy of tasks array where all added tasks will be added
    ...
    //         this.props.userInput.value = ""; // clears the add task input from input field for better user experience.
                ...
                <div className="header">
                    ...
                    <form onSubmit={(this.props.addTask)}>
                        <input className="textBox" 
                            name="todoInput"
                            // ref={(a) => this.userInput = a} placeholder="enter task" 
                        />
                        <div className="buttons">
                            <button className=" btn addBtn" type="submit"> Add Task </button>
                            {(doneCount.length > 0) && (
                                <button className="btn clearBtn" onClick={this.props.clearDoneTasks} >Clear Task</button>
                            )
                            }
                        </div>
                    </form>
